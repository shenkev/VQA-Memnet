...
class SyntheticDataset(data.Dataset):
    def __init__(self, path_to_dataset, dataset_type):
        ...
        species_clues, questions_train, questions_test, num_species, num_attributes, num_clues_per_species = pickle.load(open(path_to_dataset, "rb" ))
    ...
    def __getitem__(self, idx):
        ...
        answer:  [0, 1] = Yes or [1, 0] = No
        '''
        return self.species_clues[self.question_species[idx]], self.question_species[idx], self.questions[idx], self.answer[idx]
